...
\begin{document}
% ------------------------------------------
% หน้าปก (Title Page) - ปรับปรุงโครงสร้างใหม่ รันผ่านแน่นอน
% ------------------------------------------
\begin{titlepage}
	\centering
	...
	\definecolor{covergray}{HTML}{2D2D2D} % สีเทาเข้มคมชัด (เอา !70 !80 ออกเพื่อให้สีเข้มเต็ม 100% อ่านง่าย)
	...
	% --- ส่วนกลาง: กล่องหัวเรื่องแบบไม่มี TikZ (ปลอดภัย ไร้ข้อผิดพลาด) ---
	...
	\begin{minipage}{0.8\textwidth}
		...
		\color{coverblue}\rule{0.6\textwidth}{1.2pt}\\[0.5cm] % ปรับเส้นคั่นให้เข้มและหนาขึ้นเล็กน้อยเพื่อความคมชัด
