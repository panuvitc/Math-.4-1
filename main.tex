...
\begin{titlepage}
	...
	% ===== กำหนดสีภายในหน้าปก =====
	\definecolor{coverblue}{HTML}{7A9D8B} % สีเขียวภูมิฐานตามที่คุณเลือก
	\definecolor{covergray}{HTML}{2D2D2D} % สีเทาเข้มคมชัด
	
	% --- ส่วนบน: โลโก้คู่ ---
	\vspace*{1.0cm} % ปรับขึ้นเล็กน้อยเพื่อให้มีพื้นที่ด้านล่างเพิ่มขึ้น
	...
	\vfill % ใช้ vfill ดันกล่องข้อความให้อยู่กึ่งกลางหน้ากระดาษอย่างสมดุล
	
	% --- ส่วนกลาง: กล่องหัวเรื่องแบบไม่มี TikZ ---
	\begin{minipage}{0.85\textwidth}
		\noindent
		% ใช้โครงสร้างตารางทำแถบสีหนา 5pt ฝั่งซ้าย และทำกล่องพื้นหลังสีเขียวจางล้อมรอบข้อความ
		\begin{tabular}{!{\color{coverblue}\vrule width 5pt} p{\dimexpr\textwidth-25pt}}
			...
			\colorbox{coverblue!10}{
				\begin{minipage}[t]{\dimexpr\textwidth-25pt}
					\centering
					\vspace{20pt} % เว้นระยะขอบบนในกล่อง
					
					{\Large\bfseries\color{covergray} เอกสารประกอบการสอนคณิตศาสตร์}\\[0.8em]
					{\Huge\bfseries\color{covergray} รายวิชาเพิ่มเติม ม.4 เล่ม 1}\\[1.0em]
					{\Large\bfseries\color{covergray} หัวข้อ : จำนวนจริง}
					
					\vspace{20pt} % เว้นระยะขอบล่างในกล่อง
				\end{minipage}
			}
		\end{tabular}
	\end{minipage}
	...
	\begin{minipage}{0.8\textwidth}
		\centering
		{\large อาจารย์ผู้สอน}\\[0.4cm]
		{\huge \textbf{ภาณุวิชญ์ เชื้อพล}}\\[0.4cm]
		\color{coverblue}\rule{0.6\textwidth}{1.2pt}\\[0.5cm] 
		{\large กลุ่มสาระการเรียนรู้คณิตศาสตร์}\\[0.2cm]
		{\large โรงเรียนสาธิตมหาวิทยาลัยขอนแก่น วิทยาเขตหนองคาย}
	\end{minipage}
	
	\vfill % ดันกล่อง Disclaimer ลงไปด้านล่างสุดอย่างสวยงาม
	
	% --- ส่วนล่างสุด: กล่องแจ้งสิทธิ์และที่มาเนื้อหา (Global Disclaimer) ---
	\begin{minipage}{0.85\textwidth}
		\begin{flushleft}
			\footnotesize % ใช้ขนาดตัวอักษรเล็กพิเศษเพื่อให้ไม่แย่งความเด่นของหน้าปก
			\color{covergray!80} % ปรับสีตัวอักษรให้จางลงเล็กน้อยดูนุ่มตา
			\rule{\textwidth}{0.4pt}\\[0.15cm] % เส้นคั่นบางๆ 
			\textbf{ข้อตกลงและที่มาของเนื้อหา (Disclaimer):}\\
			เอกสารฉบับนี้จัดทำขึ้นเพื่อประโยชน์ทางการศึกษาในการจัดกิจกรรมการเรียนรู้ในชั้นเรียนเท่านั้น โครงสร้างเนื้อหา นิยาม ทฤษฎีบท ตัวอย่าง และโจทย์ปัญหาเกือบทั้งหมดในเอกสารฉบับนี้ ดัดแปลงและเรียบเรียงมาจากหนังสือเรียนรายวิชาเพิ่มเติมคณิตศาสตร์ ชั้นมัธยมศึกษาปีที่ 4 เล่ม 1 (พิมพ์ครั้งที่ 2, พ.ศ. 2568) ของสถาบันส่งเสริมการสอนวิทยาศาสตร์และเทคโนโลยี (สสวท.) โดยผู้จัดทำได้ทำการปรับปรุงรูปแบบการจัดวางและเว้นช่องว่างสำหรับแสดงวิธีทำเพื่อความเหมาะสมในชั้นเรียน มิได้มีวัตถุประสงค์เพื่อการค้าหรือแสวงหาผลกำไรใดๆ ทั้งสิ้น\\
			\rule{\textwidth}{0.4pt}
		\end{flushleft}
	\end{minipage}
	
	\vspace*{0.5cm} % ระยะห่างจากขอบล่างสุดของกระดาษ
\end{titlepage}
...
\chapter*{คำนำ} % ระบบจะดึงเข้ากล่องมีเงาสุดเท่ให้อัตโนมัติ และไม่มีคำว่า "บทที่"

เอกสารประกอบการสอนคณิตศาสตร์ รายวิชาเพิ่มเติม รหัสวิชา ค31201 ชั้นมัธยมศึกษาปีที่ 4 เล่ม 1 เรื่อง จำนวนจริง ฉบับนี้ จัดทำขึ้นเพื่อใช้เป็นสื่อหลักในการจัดการเรียนรู้ในชั้นเรียน โดยมุ่งเน้นให้นักเรียนได้พัฒนาทักษะกระบวนการคิดทางคณิตศาสตร์ ผ่านการฝึกปฏิบัติและร่วมกันแก้โจทย์ปัญหาไปพร้อมกับการจัดการเรียนการสอนของครูผู้สอนในห้องเรียน

โครงสร้างและรูปแบบของเอกสารฉบับนี้ ได้รับการออกแบบมาเป็นพิเศษโดยเว้นพื้นที่ว่างในส่วนของตัวอย่างและแบบฝึกหัด เพื่อส่งเสริมให้นักเรียนได้ฝึกฝนการเขียนแสดงวิธีทำอย่างเป็นระบบด้วยตนเอง อันจะช่วยสร้างความเข้าใจที่ลึกซึ้งและคงทนมากกว่าการอ่านเนื้อหาสำเร็จรูป รวมทั้งช่วยให้นักเรียนสามารถประเมินความเข้าใจของตนเองได้ในทันที

ผู้จัดทำขอขอบพระคุณสถาบันส่งเสริมการสอนวิทยาศาสตร์และเทคโนโลยี (สสวท.) ในฐานะเจ้าของลิขสิทธิ์หนังสือเรียนหลักที่ผู้จัดทำได้นำโครงสร้างเนื้อหา นิยาม ทฤษฎีบท และโจทย์ปัญหามาดัดแปลงและเรียบเรียงในเอกสารฉบับนี้เพื่อประโยชน์ทางการศึกษา ทั้งนี้ ผู้จัดทำหวังเป็นอย่างยิ่งว่าเอกสารประกอบการสอนฉบับนี้จะเป็นประโยชน์และช่วยพัฒนาศักยภาพทางคณิตศาสตร์ของนักเรียนได้เป็นอย่างดี
